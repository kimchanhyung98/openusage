...
- **[Kimi](docs/providers/kimi.md)** — 5-hour session and weekly coding quotas
- **[Kiro](docs/providers/kiro.md)** — coding credits and subscription plan
