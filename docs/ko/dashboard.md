...
커뮤니티 **Yes** 투표 비율은 AI 확률과 별도로 표시, 투표 결과가 없거나 조회 실패 시 예측을 유지하면서 **Votes unavailable** 표시.
...
수동 Refresh(⌘R)도 활성 Reset Watch의 예측·커뮤니티 투표를 사용량과 함께 재검증하되 오류 후 재시도 대기는 유지.
