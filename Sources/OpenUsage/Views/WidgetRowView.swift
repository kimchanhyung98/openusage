...
struct WidgetRowView: View {
    ...
    private func boundedLabelRow(_ rowData: WidgetData, state: WidgetData.MeterState) -> some View {
        HStack(spacing: 6) {
            Text(rowData.title)
                ...
                .lineLimit(1)
                .accessibilityHint(rowData.softLimitStatusText ?? "")
    ...
    private func meter(_ rowData: WidgetData, state: WidgetData.MeterState) -> some View {
        ...
        let softLimitMarker = rowData.softLimitMarkerFraction
        ...
        .animation(Motion.spring, value: rowData.softLimitMarkerFraction)
        .accessibilityHidden(true)
        .hoverTooltip(rowData.meterTooltip(for: state))
    }
